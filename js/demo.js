...
var choic;
    $('#autocomplete-ajax').autocomplete({
        ...
        onSelect: function(suggestion) {
			choic=suggestion.value;//suhail 
            $('#selction-ajax').html('You selected: ' + suggestion.value + ', ' + suggestion.data);
			//$('#autocomplete-ajax1').val($('#autocomplete-ajax').val());

        },
        onHint: function (hint) {
            $('#autocomplete-ajax-x').val(hint);
           // $('#autocomplete-ajax-x1').val(hint);
			//$('#autocomplete-ajax1').val($('#autocomplete-ajax').val());
 ...
 $('#autocomplete-ajax1').autocomplete({
        ...
        lookupFilter: function(suggestion, originalQuery, queryLowerCase) {
         //   if(lng=='eng')
           ...
           // var re = new RegExp('\\b' + $.Autocomplete.utils.escapeRegExChars(queryLowerCase), 'g');
        ...
        onSelect: function(suggestion) {
            ...
            $('#selction-ajax').html('You selected: ' + suggestion.value + ', ' + suggestion.data);
		//	$('#autocomplete-ajax').val($('#autocomplete-ajax1').val());
