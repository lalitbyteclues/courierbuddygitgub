 ...
 */
angular.module('courier').controller("admindeliveryreportmanagerController", function ($rootScope, $state, $scope, $location, ValiDatedTokenObject, locationHistoryService, AuthService) {
    $scope.errormessage = '';
