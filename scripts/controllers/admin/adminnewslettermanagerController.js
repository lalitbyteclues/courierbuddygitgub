 ...
 */
angular.module('courier').controller("adminnewslettermanagerController", function ($rootScope, $state, $scope, $location, ValiDatedTokenObject, locationHistoryService, AuthService) {
    $scope.errormessage = '';
