    ...
    ParcelService.getParcelList(sessionStorage.getItem("UserId")).then(function (results) {
        if (results.status == 200) {
            ...
            for (i = 0; i < $scope.list.length; i++) {
                ...
                if (($scope.mainlist[i].status == $scope.status || typeof $scope.status === 'undefined' || $scope.status === '' || $scope.status == null) && ($scope.mainlist[i].till_date.getDate() == new Date($scope.departureat).getDate() || typeof $scope.departureat === 'undefined' || $scope.departureat == '' || $scope.departureat == null) && (("P" + $scope.mainlist[i].id).indexOf($scope.TransporterID) != -1 || typeof $scope.TransporterID === 'undefined' || $scope.TransporterID === '' || $scope.TransporterID == null)) {
                    dTable.row.add(["P" + $scope.mainlist[i].id, $scope.mainlist[i].source, $scope.mainlist[i].destination, $scope.mainlist[i].type == 'E' ? 'Envelope' : $scope.mainlist[i].type == 'B' ? 'Box' : $scope.mainlist[i].type == 'P' ? 'Packet' : $scope.mainlist[i].type, $scope.mainlist[i].weight + " kg.", ($scope.mainlist[i].transporterID > 0 ? "<a href='javascript:void(0);' onclick='getuserdetails(" + $scope.mainlist[i].transporterID + ")'>MCB" + $scope.mainlist[i].transporterID + "</a>" : "<a href='/viewparcel/" + $scope.mainlist[i].id + "#matches' title='View Trip'>Find Matching Trips</a>"), ($scope.mainlist[i].recv_id > 0 ? "<a href='javascript:void(0);' onclick='getuserdetails(" + $scope.mainlist[i].recv_id + ")'>MCB" + $scope.mainlist[i].recv_id + "</a>" : ""), moment($scope.mainlist[i].till_date).format("DD/MM/YYYY"), $scope.mainlist[i].status == 0 ? "Parcel ID Created" : $scope.mainlist[i].status == 1 ? "Created Payment Due" : $scope.mainlist[i].status == 2 ? "Booked With TR" : $scope.mainlist[i].status == 3 ? "Parcel Collected" : $scope.mainlist[i].status == 4 ? "Parcel Delivered" : $scope.mainlist[i].status == 5 ? "Delivery Complete" : $scope.mainlist[i].status == 6 ? "Cancelled" : $scope.mainlist[i].status == 7 ? "cancelled Paid" : "Undelivered", "<div class='dropdown'>    <a href='javascript:void()' data-toggle='dropdown' class='dropdown-toggle'>Action<b class='caret'></b></a>    <ul class='dropdown-menu'>        <li><a href='/viewparcel/" + $scope.mainlist[i].id + "' title='View parcel'>View parcel</a> </li>        <li> <a href='/editparcel/" + $scope.mainlist[i].id + "' title='Cancel parcel'>Edit parcel</a></li><li> <a href='javascript:void(0);'  onclick='cancelparcellist(" + $scope.mainlist[i].id + ")'   title='Cancel parcel'>Cancel parcel</a> </li>" + ($scope.mainlist[i].status == 4 ? "<li><a href='javascript:void(0);'  onclick='changestatusparcel(" + $scope.mainlist[i].id + ",1)'   title='Cancel Status'>Delivered</a></li><li><a href='javascript:void(0);'  onclick='changestatusparcel(" + $scope.mainlist[i].id + ",0)'   title='Cancel Status'>Not Delivered</a></li>" : "") + "</ul></div>"]).draw();
                }
                //    dTable.row.add(["P" + $scope.mainlist[i].id, $scope.mainlist[i].source, $scope.mainlist[i].destination, $scope.mainlist[i].type == 'E' ? 'Envelope' : $scope.mainlist[i].type == 'B' ? 'Box' : $scope.mainlist[i].type == 'P' ? 'Packet' : $scope.mainlist[i].type, $scope.mainlist[i].weight + " kg.", ($scope.mainlist[i].transporterID > 0 ? "<a href='javascript:void(0);' onclick='getuserdetails(" + $scope.mainlist[i].transporterID + ")'>MCB" + $scope.mainlist[i].transporterID + "</a>" : ""), ($scope.mainlist[i].recv_id > 0 ? "<a href='javascript:void(0);' onclick='getuserdetails(" + $scope.mainlist[i].recv_id + ")'>MCB" + $scope.mainlist[i].recv_id + "</a>" : ""), $scope.mainlist[i].status == 0 ? "Parcel ID Created" : $scope.mainlist[i].status == 1 ? "Created Payment Due" : $scope.mainlist[i].status == 2 ? "Booked With TR" : $scope.mainlist[i].status == 3 ? "Parcel Collected" : $scope.mainlist[i].status == 4 ? "Parcel Delivered" : $scope.mainlist[i].status == 5 ? "Delivery Complete" : $scope.mainlist[i].status == 6 ? "Cancelled" : $scope.mainlist[i].status == 7 ? "cancelled Paid" : "Undelivered", "<div class='dropdown'>    <a href='javascript:void()' data-toggle='dropdown' class='dropdown-toggle'>Action<b class='caret'></b></a>    <ul class='dropdown-menu'>        <li><a href='/viewparcel/" + $scope.mainlist[i].id + "' title='View parcel'>View parcel</a> </li>        <li> <a href='/editparcel/" + $scope.mainlist[i].id + "' title='Cancel parcel'>Edit parcel</a></li><li> <a href='javascript:void(0);'  onclick='cancelparcellist(" + $scope.mainlist[i].id + ")'   title='Cancel parcel'>Cancel parcel</a> </li></ul></div>"]).draw();
            }
        }
    });
