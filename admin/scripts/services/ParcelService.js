...
angular.module('courier').factory('ParcelService', ['$http', '$q', 'RESOURCES', 'ValiDatedTokenObject', function ($http, $q, RESOURCES, ValiDatedTokenObject) {
    ...
    var _getalldeliveryreportslist = function (data) {
        return $http.post(serviceBase + 'api/alldeliveryreportslist', data, {
            headers: { 'Content-Type': 'application/json' }
        }).then(function (results) {
            return results;
        });
    ...
    ParcelServiceFactory.getalldeliveryreportslist = _getalldeliveryreportslist;
